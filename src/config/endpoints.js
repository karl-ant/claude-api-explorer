...
const endpoints = {
  messages: {
    ...
    parameters: {
      ...
      optional: ['system', 'temperature', 'top_p', 'top_k', 'tools', 'tool_choice', 'stream', 'metadata', 'stop_sequences', 'thinking', 'output_config', 'speed', 'container', 'inference_geo', 'context_management', 'service_tier']
    },
